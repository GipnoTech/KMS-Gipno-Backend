...
Route::screen('/trainings',\App\Orchid\Screens\TrainingScreen::class)->name('kms.training');
Route::screen('/trainings/{training}',\App\Orchid\Screens\ViewTrainingScreen::class)->name('kms.training.view');
Route::screen('/trainings/{training}/edit',\App\Orchid\Screens\TrainingEditScreen::class)->name('kms.training.edit');



Route::screen('/tests',\App\Orchid\Screens\TestsScreen::class)->name('kms.tests');
Route::screen('/tests/{test}',\App\Orchid\Screens\TestingScreen::class)->name('kms.test.view');
Route::screen('/tests/{test}/edit',\App\Orchid\Screens\TestEditScreen::class)->name('kms.test.edit');
Route::screen('/tests/{test}/result',\App\Orchid\Screens\TestResultScreen::class)->name('kms.test-result');
